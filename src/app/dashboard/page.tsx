    ...
    <div className="min-h-screen bg-navy-900 text-white">
      ...
      <nav className="border-b border-slate-800 px-6 py-0 flex items-center justify-between h-16">
        ...
        <div className="flex-shrink-0">
          <img src="/logo.png" alt="SignalOps" className="h-10" />
        </div>

        {/* Centre title */}
        <div className="absolute left-1/2 -translate-x-1/2">
          <span className="text-sm font-semibold text-slate-300 tracking-wide uppercase">Revenue Intelligence Platform</span>
        </div>
